...
class Fund(models.Model):
    p = models.OneToOneField('Project', models.DO_NOTHING, primary_key=True)
    u = models.ForeignKey(AuthUser, models.DO_NOTHING)
    ...
    class Meta:
        managed = False
        db_table = 'fund'
        unique_together = (('p', 'u', 'created_at'),)
...
class Project(models.Model):
    ...
    goal = models.DecimalField(max_digits=18, decimal_places=2)
